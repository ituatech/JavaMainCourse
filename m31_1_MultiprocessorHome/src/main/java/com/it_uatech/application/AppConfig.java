...
import com.it_uatech.api.service.*;
...
public class AppConfig {
    ...
    @Bean(name = "messageSystemContext")
    MessageSystemContext getMessageSystemContext(SessionManagerHibernate sessionManagerHibernate){
        ...
        Gson gson = new Gson();
        FrontendService frontendService = new FrontendServiceImpl(frontAddress,context,gson);
        frontendService.init();

        UserDao dao = new UserDaoImpl(sessionManagerHibernate);
        DBServiceUser dbService = new DBServiceUserImpl(dao,dbAddress,context);
        dbService.init();
        return context;
    }
